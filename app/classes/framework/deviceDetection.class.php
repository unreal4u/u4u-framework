<?php
/**
 * Detects a mobile user. Can optionally speak with WURFL to get accurate data about what a mobile device is
 *
...
class deviceDetection {
     ...
     *
     * This code is copied from WurflCloudClient-v1.0.2/Client/Client.php
     *
     * @var array
     */
     ...
     *
     * This piece of code is copied from WurflCloudClient-v1.0.2/Client/Client.php
     *
     * @param mixed $source
     */
     ...
     * accuracy from 97,6% (364 bad detections) to 98,8% (182 bad detections)
     *
     * @see http://blog.unreal4u.com/2012/10/detectar-facilmente-un-dispositivo-movil/
     *
    ...
    protected function doWurflCloudRequest() {
        ...
        try {
            ...
            // @TODO CS@2013-07-08 Maybe get this data from $appContainer->options ?
